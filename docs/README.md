...
### 입력 기능
- [ ] 사용자가 방문 날짜를 입력할 수 있도록 요청합니다.
  - `12월 중 식당 예상 방문 날짜는 언제인가요? (숫자만 입력해 주세요!)`
- [ ] 사용자가 메뉴와 수량을 입력할 수 있도록 요청합니다.
...
- [ ] 할인 전 총주문 금액을 계산하고 출력합니다.
- [ ] 증정 메뉴를 출력합니다 (해당하는 경우).
